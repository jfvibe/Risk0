                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTermsSection(
                        ...
                        'Risk0 es una plataforma de información y recomendación de seguros. No es aseguradora, no emite pólizas ni vende productos ni gestiona reclamaciones.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '2. Alcance de las recomendaciones',
                        'Las sugerencias se generan con datos aproximados del usuario y estimaciones de riesgo por ubicación. No constituyen asesoría financiera, actuarial, legal o fiscal personalizada ni garantizan la idoneidad absoluta de un producto.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '3. Contratación con terceros',
                        'La cotización, contratación, pago, cancelación, consultas y reclamaciones deben realizarse directamente con la aseguradora correspondiente, conforme a sus términos y condiciones.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '4. Transparencia de compensaciones',
                        'Risk0 puede recibir compensación o comisión por referido de ciertas aseguradoras cuando el usuario cotiza o contrata. Esta compensación no incrementa el precio al usuario ni condiciona la neutralidad del motor de recomendación.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '5. Obligaciones del usuario',
                        'El usuario se compromete a proporcionar información veraz y a no usar la plataforma con fines fraudulentos, ilícitos o engañosos.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '6. Exactitud y vigencia de la información',
                        'La información y cotizaciones provienen de terceros y pueden cambiar sin previo aviso. Risk0 no garantiza permanencia, exactitud, exhaustividad ni actualización continua.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '7. Limitación de responsabilidad',
                        'Risk0 no será responsable por daños directos, indirectos, consecuenciales o lucro cesante derivados del uso de la plataforma o de decisiones tomadas con base en su contenido.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '8. Modificaciones',
                        'Risk0 podrá modificar estos Términos y Condiciones en cualquier momento mediante su publicación en la plataforma. El uso continuado implica aceptación de la versión vigente.',
                      ),
                      const SizedBox(height: 20),
                      _buildTermsSection(
                        '9. Contacto',
                        'Para consultas o soporte, escribe a client.support@risk0.com.',
                      ),
                    ],
                  ),
                ),
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _loadPolicies() {
    final allPolicies = [
      InsurancePolicy(id: 'MX_CASA_HUR', insurer: 'GNP Seguros', category: 'Casa', type: 'Huracán', premium: 6500, coverage: 250, deductible: 0, description: 'Activación automática por viento >80km/h', isParametric: true, populalityScore: 95),
      InsurancePolicy(id: 'MX_CASA_INU', insurer: 'AXA México', category: 'Casa', type: 'Inundación', premium: 7000, coverage: 300, deductible: 0, description: 'Pago inmediato por lluvia >150mm/24h', isParametric: true, populalityScore: 88),
      InsurancePolicy(id: 'MX_COCHE_GRA', insurer: 'Qualitas', category: 'Coche', type: 'Granizo', premium: 12000, coverage: 150, deductible: 0, description: 'Cobertura por granizo >2cm de diámetro', isParametric: true, populalityScore: 85),
      InsurancePolicy(id: 'MX_COCHE_COL', insurer: 'Mapfre', category: 'Coche', type: 'Colisión', premium: 13500, coverage: 500, deductible: 100, description: 'Cobertura tradicional para accidentes', isParametric: false, populalityScore: 90),
      InsurancePolicy(id: 'MX_VIDA_ACC', insurer: 'MetLife', category: 'Vida', type: 'Accidental', premium: 8000, coverage: 1000, deductible: 0, description: 'Protección por desastre natural', isParametric: true, populalityScore: 94),
      InsurancePolicy(id: 'MX_SALUD_URG', insurer: 'SURA', category: 'Salud', type: 'Urgencias', premium: 20000, coverage: 300, deductible: 0, description: 'Atención médica inmediata en desastres', isParametric: true, populalityScore: 87),
      InsurancePolicy(id: 'MX_NEG_INT', insurer: 'AIG', category: 'Negocio', type: 'Interrupción', premium: 15300, coverage: 800, deductible: 0, description: 'Compensación por pérdida de ingresos', isParametric: true, populalityScore: 73),
      InsurancePolicy(id: 'MX_AGR_SEQ', insurer: 'Agroasemex', category: 'Agrícola', type: 'Sequía', premium: 4750, coverage: 200, deductible: 0, description: 'Activación por déficit de lluvia >30 días', isParametric: true, populalityScore: 68),
    ];
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                      ...
                      child: const Text('Contratar', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                ),
              ],
            ),
          ],
                ...
                children: [
                  Wrap(
                    ...
                    children: ['Casa', 'Coche', 'Vida', 'Salud', 'Negocio', 'Agrícola'].map((cat) => FilterChip(
                      label: Text(cat, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
      ...
      body: data.coverageByCategory.isEmpty
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('No tienes pólizas activas', style: TextStyle(color: Colors.grey[600], fontSize: 18)),
            const SizedBox(height: 16),
            ElevatedButton.icon(
              onPressed: () => Navigator.pop(context),
            ...
            children: data.entries.map((entry) {
              ...
              return Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text(entry.key, style: TextStyle(color: isDark ? Colors.white : const Color(0xFF1E293B), fontSize: 15, fontWeight: FontWeight.w500)),
                ],
              );
            }).toList(),
          ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Ubicación: ${location.toUpperCase()}', style: TextStyle(fontSize: 22, color: isDark ? Colors.white70 : Colors.grey[700])),
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('📊 HISTÓRICO DE DESASTRES', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isDark ? Colors.white : const Color(0xFF1E293B))),
                      const SizedBox(height: 12),
                      Text(details['history'] as String, style: TextStyle(fontSize: 16, height: 1.6, color: isDark ? Colors.grey[300] : Colors.grey[700])),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('🛡️ RECOMENDACIONES DE PREVENCIÓN', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isDark ? Colors.white : const Color(0xFF1E293B))),
                      const SizedBox(height: 12),
                      Text(details['prevention'] as String, style: TextStyle(fontSize: 16, height: 1.6, color: isDark ? Colors.grey[300] : Colors.grey[700])),
                    ],
                  ),
                ),
              ],
      ...
      body: policies.isEmpty
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            const Text('No tienes pólizas activas', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            Text('Contrata tu primera póliza desde el inicio', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
          ],
        ),
      )
          : ListView.builder(
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text('Redirigiendo a la aseguradora...', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
          const SizedBox(height: 8),
          Text('Por favor espera', style: TextStyle(fontSize: 16, color: Colors.grey[600])),
        ],
      ),
    );
  }
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          const CircularProgressIndicator(),
          const SizedBox(height: 20),
          Text(message, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: [
        TextButton(
          onPressed: () => Navigator.pop(context),
          child: const Text('OK', style: TextStyle(color: Colors.green, fontSize: 16, fontWeight: FontWeight.w600)),
        ),
      ],
    );
  }
